...
@section('title')
    <h1 class="section-title mt-2 pb-4">Employee Activities</h1>
@endsection

@section('controls')
    <li class="active"><a data-toggle="tab" class="h5 text-decoration-none m-0" href="#home">Employee Activity Logs</a></li>
    <li><a data-toggle="tab" class="h5 text-decoration-none m-0" href="#menu1">Employee Activity  History</a></li>
@endsection
                    ...
                    $('#audit_table').DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'employee.user_detail.fname',
                                render : (data,type,row)=>{
                                    return `<b>${data} ${row.employee.user_detail.mname} ${row.employee.user_detail.lname}</b>`
                                }
                            },
                            { data: 'description',
                                render : (data,type,row)=>{
