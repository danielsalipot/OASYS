...
@section('second')
    <div class="row mb-3 mt-3 input-daterange" >
        <div class="col-md-2">
            <input type="text" name="from_date" id="from_date" class="form-control p-3 h-100" placeholder="From Date" value="{{ $date_filter[0] }}" readonly />
        </div>
        <div class="col-md-2">
            <input type="text" name="to_date" id="to_date" class="form-control h-100" placeholder="To Date" value="{{ $date_filter[1] }}" readonly />
        </div>
        <div class="col-2">
    ...
    <script>
        ...
        $('#refresh').click(function(){
            $('#from_date').val('{{ $date_filter[0]}}');
            $('#to_date').val('{{ $date_filter[1]}}');
